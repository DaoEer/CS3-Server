"""
Django settings for cs3_web_services project.
...
SECRET_KEY = '4d&5d)=3(5#+8eiy^ks3jsunsjde=*ys119#nv@r-=)-kj#vtf'
...
ROOT_URLCONF = 'cs3_web_services.urls'
...
WSGI_APPLICATION = 'cs3_web_services.wsgi.application'
